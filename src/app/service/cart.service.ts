...
export class CartService {
  ...
  constructor() { 
    ...
    let data = JSON.parse(this.storage.getItem('cartData')!); // parse give JSON to object
  ...
  persistCartItems(){
    this.storage.setItem('cartData',JSON.stringify(this.cartItem)); // strinfify convert object to json
  }
}
